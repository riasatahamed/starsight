const CACHE_NAME = 'starsight-v29';
...
const APP_SHELL = [
  ...
  './style.css?v=29',
  './data.js?v=29',
  './expanded_stars.js?v=29',
  './telescope.js?v=29',
  './observingLog.js?v=29',
  './api.js?v=29',
  './main.js?v=29',
  './manifest.json?v=29',
  './images/StarSight_Logo.png?v=29'
];
      ...
      fetch(request, { cache: 'no-store' })
        .then(response => {
          if (response.ok) {
            ...
            caches.open(CACHE_NAME).then(cache => cache.put('./index.html?v=29', copy)).catch(() => {});
          }
          return response;
        })
        .catch(() => caches.match('./index.html?v=29').then(r => r || caches.match('./index.html')))
    );
    return;
  }
