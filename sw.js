const CACHE_NAME = 'starsight-v24';
...
const APP_SHELL = [
  ...
  './style.css?v=24',
  './data.js?v=24',
  './expanded_stars.js?v=24',
  './telescope.js?v=24',
  './observingLog.js?v=24',
  './api.js?v=24',
  './main.js?v=24',
  './manifest.json?v=24',
  './images/StarSight_Logo.png?v=24'
];
      ...
      fetch(request, { cache: 'no-store' })
        .then(response => {
          if (response.ok) {
            ...
            caches.open(CACHE_NAME).then(cache => cache.put('./index.html?v=24', copy)).catch(() => {});
          }
          return response;
        })
        .catch(() => caches.match('./index.html?v=24').then(r => r || caches.match('./index.html')))
    );
    return;
  }
