const CACHE_NAME = 'starsight-v31';
...
const APP_SHELL = [
  ...
  './style.css?v=31',
  './data.js?v=31',
  './expanded_stars.js?v=31',
  './telescope.js?v=31',
  './observingLog.js?v=31',
  './api.js?v=31',
  './main.js?v=31',
  './manifest.json?v=31',
  './images/StarSight_Logo.png?v=31'
];
      ...
      fetch(request, { cache: 'no-store' })
        .then(response => {
          if (response.ok) {
            ...
            caches.open(CACHE_NAME).then(cache => cache.put('./index.html?v=31', copy)).catch(() => {});
          }
          return response;
        })
        .catch(() => caches.match('./index.html?v=31').then(r => r || caches.match('./index.html')))
    );
    return;
  }
