const CACHE_NAME = 'starsight-v28';
...
const APP_SHELL = [
  ...
  './style.css?v=28',
  './data.js?v=28',
  './expanded_stars.js?v=28',
  './telescope.js?v=28',
  './observingLog.js?v=28',
  './api.js?v=28',
  './main.js?v=28',
  './manifest.json?v=28',
  './images/StarSight_Logo.png?v=28'
];
      ...
      fetch(request, { cache: 'no-store' })
        .then(response => {
          if (response.ok) {
            ...
            caches.open(CACHE_NAME).then(cache => cache.put('./index.html?v=28', copy)).catch(() => {});
          }
          return response;
        })
        .catch(() => caches.match('./index.html?v=28').then(r => r || caches.match('./index.html')))
    );
    return;
  }
