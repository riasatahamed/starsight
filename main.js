...
function updateMapHint() {
    ...
    if (arMode) {
        ...
        hint.textContent = rotateMode ? 'drag to rotate · pinch to zoom · tap a star for info' : 'drag to pan · pinch to zoom · tap a star for info';
    } else if (rotateMode) {
        hint.textContent = 'drag to rotate · scroll/pinch to zoom · hover for info';
    } else {
        hint.textContent = 'drag to pan · scroll to zoom · hover for info · double-click to slew';
    }
}
